...
// wildcard character
var regex1, keys1, _ = Compile("/foo/bar/:uid/awesome/beez/*")
var str1 = "/foo/bar/uid/awesome/beez/x"
...
// params
var regex2, keys2, _ = Compile("/hello/world/:foo/user/:bar")
var str2 = "/hello/world/foo/user/bar"
